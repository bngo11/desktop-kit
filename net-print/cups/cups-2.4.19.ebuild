...
SRC_URI="https://github.com/OpenPrinting/cups/releases/download/v2.4.19/cups-2.4.19-source.tar.gz -> cups-2.4.19-source.tar.gz"
KEYWORDS="*"
...
multilib_src_install_all() {
	...
	rm -rf "${ED}"/etc/{init.d/cups,rc*} || die
