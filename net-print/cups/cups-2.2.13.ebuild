...
inherit autotools gnome3-utils flag-o-matic linux-info multilib-minimal pam user java-pkg-opt-2
...
LICENSE="GPL-2"
SLOT="0"
IUSE="acl dbus debug java kerberos lprng-compat pam python selinux +ssl static-libs +threads usb X xinetd zeroconf"
