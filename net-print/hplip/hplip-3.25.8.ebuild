...
SRC_URI="https://sourceforge.net/projects/hplip/files/hplip/3.25.8/hplip-3.25.8.tar.gz -> hplip-3.25.8.tar.gz
https://dev.gentoo.org/~billie/distfiles/hplip-3.25.8-patches-1.tar.xz -> hplip-3.25.8-patches-1.tar.xz
"
