...
SRC_URI="https://sourceforge.net/projects/hplip/files/hplip/3.25.2/hplip-3.25.2.tar.gz -> hplip-3.25.2.tar.gz
https://dev.gentoo.org/~billie/distfiles/hplip-3.25.2-patches-1.tar.xz -> hplip-3.25.2-patches-1.tar.xz
"
